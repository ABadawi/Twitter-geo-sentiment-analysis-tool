...
'''
Training data should be a list of tuples where the first item in the 
pair is the phrase and the second item is the setiment (pos, neg)


So, Let's actually create that list from the txt file 
'''
...
# classifierType = input('Enter your classifier of choice: Naive or Decision Tree ')
# 
# if classifierType == 'Naive':
